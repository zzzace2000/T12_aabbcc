...
public class mainFram extends JFrame {
	...
	public mainFram(cClient tc) {
		...
		setTitle("NMLAB ºô¦h¾Ô¶¤-team12 ²á¤Ñ«Ç");
		...
		JLabel label_1 = new JLabel("·í«e²á¤Ñ«Ç¦b½u");
		...
		btnNewButton_3.setToolTipText("?œæ–¼");
		...
		tabbedPane.addTab("å¤§å»³", null, panel_3, null);
		tablabel main = new tablabel("å¤§å»³", panel_3);
	...
	class tablabel extends JPanel implements ActionListener{
		...
		tablabel(String name, JPanel tmp){
			...
			if(name == "å¤§å»³") exit.setEnabled(false);
			add(tabname);
			add(exit);
		}
		public void actionPerformed(ActionEvent e){
