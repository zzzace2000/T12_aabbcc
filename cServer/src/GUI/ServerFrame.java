...
public class ServerFrame extends JFrame {
	...
	public ServerFrame(cServer ts) {
		...
		guestPanel.setBounds(10, 10, 69, 242);
		contentPane.add(guestPanel);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBackground(Color.WHITE);
		panel_1.setBounds(89, 10, 335, 172);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				theServer.broadCast(textPane.getText());
				textPane.removeAll();
				textPane.setText("");
			}
		});
		...
		btnNewButton.setBounds(363, 191, 61, 61);
		...
		textPane.setBounds(90, 191, 270, 61);
    ...
    public synchronized void log(String text) {
    	...
    	JTextArea tmp = new JTextArea(text);
